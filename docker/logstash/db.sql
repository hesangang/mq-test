...
CREATE TABLE `t_brand` (
                           ...
                           PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COMMENT='品牌';


-- es_db.t_category definition

CREATE TABLE `t_category` (
                              `id` bigint(18) NOT NULL COMMENT '主键ID',
                              `parent_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '所属类别ID',
...
-- es_db.t_product definition

CREATE TABLE `t_product` (
                             `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
                             `product_code` varchar(100) NOT NULL COMMENT '商品编码',
                             `cate_code` varchar(100) NOT NULL COMMENT '品类编码',
                             ...
                             `update_time` datetime NOT NULL COMMENT '更新时间',
                             PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8mb4 COMMENT='商品';
