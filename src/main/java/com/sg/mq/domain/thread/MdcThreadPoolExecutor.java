...
public class MdcThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    public static MdcThreadPoolExecutor newWithCurrentMdc(int corePoolSize
            , int maximumPoolSize
            , long keepAliveTime
            , TimeUnit unit
            , BlockingQueue<Runnable> workQueue) {
    ...
    public MdcThreadPoolExecutor(Map<String, String> fixedContext, int corePoolSize, int maximumPoolSize,
        ...
        super(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue,new CustomizableThreadFactory("batch-execute-thread-pool-"));
